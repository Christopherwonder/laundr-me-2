...
def setup_and_teardown():
    ...
    # Create dummy users
    user1 = Profile(user_id=1, laundr_id="@user1", bio="user 1", user_intent_id="ui_1", kyc_status="verified")
    user2 = Profile(user_id=2, laundr_id="@user2", bio="user 2", user_intent_id="ui_2", kyc_status="verified")
    db_profiles[1] = user1
    db_profiles[2] = user2
...
def test_request_load_success():
    ...
    assert data["message"] == "Load request created successfully. The sender has been notified."
